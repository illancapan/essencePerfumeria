...
![Captura authenticateToken.js ](img/req3a.JPG) ![Captura pruebas de autenticacion y rutas protegidas ](img/req3b.JPG)

---

## 4. Usar el paquete CORS para permitir las consultas de orígenes cruzados.

![Captura CORS en server.js](img/req4a.JPG) ![Captura pruebas de CORS en terminal](img/req4b.JPG)

---

## 5. Utilizar middlewares para validar las credenciales o token en cabeceras en las rutas que aplique.

![Captura authenticateToken server.js](img/req5a.JPG) ![Captura authenticateToken.js](img/req5b.JPG)
