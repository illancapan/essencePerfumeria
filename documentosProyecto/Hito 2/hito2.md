...
![Captura componentes Header y Footer](img/req2a.JPG) ![Captura componentes Header y Footer importados en distintas vistas](img/req2b.JPG)
...
![Captura utilizacion de dependencia React Router](img/req3.JPG)

---

## 4. Utilizar Context API para el manejo de estado global.

![Captura Context](img/req4.JPG)
